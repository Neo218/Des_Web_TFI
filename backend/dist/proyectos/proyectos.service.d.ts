...
export declare class ProyectosService {
    ...
    constructor(proyectosRepository: Repository<Proyecto>, clientesService: ClientesService, tareasService: TareasService);
    create(createProyectoDto: CreateProyectoDto): Promise<{
        id: number;
    }>;
    ...
    update(id: number, updateProyectoDto: UpdateProyectoDto): Promise<ListProyectoDto>;
